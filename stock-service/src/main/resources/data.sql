...
insert into DraftDetails ( OSid, itemId, quantity) values ( 1, 1, 24)
insert into DraftDetails ( OSid, itemId, quantity) values ( 1, 2, 24)
insert into DraftDetails ( OSid, itemId, quantity) values ( 1, 3, 24)
insert into DraftDetails ( OSid, itemId, quantity) values ( 1, 4, 24)

insert into DraftLog (date, reason, userId) values ("2019-02-01 09:00:00", "2019  feb openstock", 1)
        
insert into DraftDetails ( OSid, itemId, quantity) values ( 2, 1, 24)
insert into DraftDetails ( OSid, itemId, quantity) values ( 2, 2, 24)
insert into DraftDetails ( OSid, itemId, quantity) values ( 2, 3, 24)
insert into DraftDetails ( OSid, itemId, quantity) values ( 2, 4, 24)
